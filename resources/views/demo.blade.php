		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-nav-demo">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="pro"><img src="boy3.jpeg" style="width:40px; height:40px; border-radius:40px; "/></a></li>
				</ul>
			</div>
		</div>
	</nav>
	<div class="container">
                        ...
                        <div class="card-body little-profile text-center">
                            ...
                            <div class="row text-center m-t-20">
                                <div class="col-lg-4 col-md-4 m-t-20">
                                    <h3 class="m-b-0 font-light">10434</h3><small>Post</small>
                                </div>
                                <div class="col-lg-4 col-md-4 m-t-20">
		...
		<div class="row">
			<div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
                    <span><img src="boy3.jpeg" style="width:50px; height:50px; border-radius:50px; margin:1px 5px 3px 1px;"  /><b>neha   <a> Follow</a></b></span>
					<img src="boy3.jpeg" style="width:300px; height:300px "/>
                    <a href="delete"><span class="material-symbols-outlined" style="margin: 0px 0px 0px 320px;">delete_sweep</span></a>
                    <br>
				</div>
			</div>
	    </div>
