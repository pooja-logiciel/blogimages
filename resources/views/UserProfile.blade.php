...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-nav-demo">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="pro"><img src="{{asset('storage/'.$data[0]['path'])}}" style="width:40px; height:40px; border-radius:40px; "/></a></li>
				</ul>
			</div>
		</div>
	</nav>
	<div class="container">
                    ...
                    <div class="card">
                        <div class="card-body little-profile text-center">
                            ...
                            <div class="row text-center m-t-20">
                                ...
                                <div class="col-lg-4 col-md-4 m-t-20">
                                    <h3 class="m-b-0 font-light">{{$data[0]['follower_count']}}</h3><small>Followers</small>
                                </div>
                                <div class="col-lg-4 col-md-4 m-t-20">
                                    <h3 class="m-b-0 font-light">{{$count}}</h3><small>Following</small>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<div class="row">
            @foreach ($data[0]['userimage'] as $row )
            <div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
					...
					<img src="{{asset('storage/'.$row['path'])}}" style="width:400px; height:400px "/>
