		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-nav-demo">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="logout"><img src="" style="width:40px; height:40px; border-radius:40px; "/></a></li>
				</ul>
			</div>
		</div>
	</nav>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
                    <span><img src="boy2.jpeg" style="width:50px; height:50px; border-radius:50px; margin:1px 5px 3px 1px;"  /><b>dfgd</b></span>
