		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-nav-demo">
				...
				<ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{url('pro')}}"><img src="{{asset('storage/'.$user[0]['path'])}}" style="width:40px; height:40px; border-radius:40px; "/></a></li>
				</ul>
			</div>
		</div>
	</nav>
                    ...
                    <div class="card">
                        <div class="card-body little-profile text-center">
                            ...
                            <p>Web Designer &amp; Developer</p>
                                @if($check==0)
                                    <a href="{{url('follower/')}}/{{$data[0]['id']}}">Follow</a>
                                @else
                                  <a href="{{url('Updatefollower/')}}/{{$data[0]['id']}}">Following</a>
                                @endif
