	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-sm-6">
				<div class="thumbnail">
                    <span><img src="{{asset('storage/'.$row['user']['path'])}}" style="width:50px; height:50px; border-radius:50px; margin:1px 5px 3px 1px;"  /><b>{{$row['user']['name']}} </b></span>
					<img src="{{asset('storage/'.$row['image']['path'])}}" style="width:300px; height:300px "/>
                    <a href="AddToFavrt/{{$row['id']}}"><span class="material-symbols-outlined" style="margin: 0px 0px 0px 320px;">delete_sweep</span></a>
                    <br>
				</div>
			</div>
            @endforeach
